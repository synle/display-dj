...
type Command =
  ...
  | 'command/changeBrightness/20'
  | 'command/changeBrightness/25'
  | 'command/changeBrightness/30'
  | 'command/changeBrightness/40'
  | 'command/changeBrightness/50'
  | 'command/changeBrightness/60'
  | 'command/changeBrightness/70'
  | 'command/changeBrightness/75'
  | 'command/changeBrightness/80'
  | 'command/changeBrightness/90'
