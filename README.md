...
- **Volume and output control** -- system volume slider with mute indicator, click-to-rename active speaker name in collapsed or expanded mode, and an expanded list with large radio targets for switching playback devices
